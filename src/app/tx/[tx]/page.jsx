...
export default function Page({ params }) {
  ...
  if (!receipt) {
    return  <> <Navbar selectedItem={selectedItem} handleItemClick={handleItemClick} /> <div className="flex justify-center items-center h-screen"><div class="border border-blue-300 shadow rounded-md p-4 max-w-sm w-full mx-auto">
